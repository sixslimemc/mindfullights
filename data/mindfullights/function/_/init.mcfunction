...
data modify storage mindfullights:config torch.copper set value {burn_time:12000, burnout_percent:1.0f, brightness:{min:1, max:14}, burn_time_per_additional:1360, extinguish_in_water:true, particles:1}
