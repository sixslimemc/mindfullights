#> mindfulp-lights:_/sc/manifest
#--------------------
# MANIFEST
#--------------------

data modify storage slimecore:in manifest.pack set value "mindfulp-lights"
...
data modify storage slimecore:in manifest.dependencies append value {pack:"emissive", url:"TODO", version:{major:1, minor:0, patch:0}}
