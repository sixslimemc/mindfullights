...
scoreboard players operation *y _mindfulp-lights += *var.torch.min_light _mindfulp-lights

execute if score *y _mindfulp-lights > *var.torch.max_light _mindfulp-lights run return run scoreboard players get *var.torch.max_light _mindfulp-lights
return run scoreboard players get *y _mindfulp-lights