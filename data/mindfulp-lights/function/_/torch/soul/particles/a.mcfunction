...
execute if score *cache.torch.normal.particles _mindfulp-lights matches 1 run particle soul_fire_flame ~ ~0.5 ~ 0 0.03 0 0.003 1 normal
execute if score *cache.torch.normal.particles _mindfulp-lights matches 2.. run particle soul_fire_flame ~ ~0.5 ~ 0 0.03 0 0.003 1 force
