...
# set item
data merge entity @s {Item:{components:{"minecraft:custom_data":{_:true, __:true, mindfulp-lights:{torch:{type:"normal", burnt:false}}}, "minecraft:item_name":"Burning Torch", "minecraft:rarity":"uncommon"}}}
